...
public class JobScheduleCreator {
     ...
     * @param jobDataMap Job input data or extra information
    ...
    public JobDetail createJob(Class<? extends QuartzJobBean> jobClass, boolean isDurable,
        ...
        // set job data map
        JobDataMap vjobDataMap = jobDataMap == null ? new JobDataMap() : jobDataMap;
        vjobDataMap.put(jobName + jobGroup, jobClass.getName());

        factoryBean.setJobDataMap(vjobDataMap);
